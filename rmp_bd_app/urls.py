...
urlpatterns = [
    ...
    path('departments/<int:university_id>', views.departments, name='departments'),
    # Page for adding a new University
    path('new_university/', views.new_university, name='new_university'),
    # Page for faculty listing
    path('professors/<int:department_id>', views.professor, name='professor'),
    path('professor_details/<int:faculty_id>', views.professor_details, name='professor_details'),
